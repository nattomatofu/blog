...
const metaDescription =
    "どうも、納豆大好きnattoです。フロントエンドはほとんど未経験の社会人が、この度Next.jsでブログを作成してみました。作成着手前の自身のスキルや、HTML / CSS / JavaScript（React）の勉強にかけた時間をご紹介します。また、勉強する際にためになったUdemyの講座についてもご紹介しています。";
