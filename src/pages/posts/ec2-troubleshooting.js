                ...
                <div className="container mx-auto px-5 xl:pl-52">
                    ...
                    <section>
                        ...
                        <div className="mt-8 md:p-8">
                            ...
                            <p className="md:p-8">
                                最終的に確認したいのは、Nginxのサーバの挙動だったので、コンソール上でEC2を立ち上げた後、まずEC2インスタンスへインターネットから HTTP / HTTPS
                                で接続できるようにインバウンドルールの設定を行いました。
                                デフォルトのインバウンドルールでは、インスタンスのいるセキュリティグループからポート80番（HTTP）へのアクセスしか許可されていなかったため、 具体的には「0.0.0.0 /
                    ...
                    <section>
                        ...
                        <div className="mt-8 md:p-8">
                            ...
                            <p className="md:p-8">
                                ...
                                <br />
                                <img
                                    src={"/images/ec2-troubleshooting/インスタンスに接続できませんでしたエラー画面.png"}
                            ...
                            <p className="md:p-8">
                                ...
                                <br />
                                <br />
                                <span className="font-bold underline decoration-red-400 decoration-2">手順②の最後のインスタンスの再起動は意外と忘れがちなので、忘れないように再起動しましょう。</span>
                            </p>
                        </div>
                    </section>
                    <section>
