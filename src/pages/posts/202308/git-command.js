                    ...
                    <section>
                        ...
                        <div className="mt-8">
                            <div className="md:p-8">
                                ...
                                上のmvコマンドを実行すると、ワークツリーだけでなくステージにも変更が反映された状態になります。すなわち、変更後git
                                addした状態になるということです。 <br />
                                ...
                                「git remote
                                add」の部分でリモートリポジトリを登録して、その後の「origin」で今後使用するリモートリポジトリの省略名を設定します。
                                <br />
                                ...
                                例としては、「git config --global alias.co
                                commit」のような感じです。
                                <br />
                                ...
                                <br />
                                また、前回のaddコマンド実行時からの全ファイルの変更を取り消したい場合は、「git
                                checkout --
                                .」のコマンドで取り消すことができます。
                                <p className="mt-4 font-bold">
                                ...
                                pullコマンドは、fecth →
                                mergeの順番でコマンドを実行した場合と同じ挙動となります。
                                <br />
                                ...
                                例としては「git branch feature
                                origin/feature」のような感じです。
                                <p className="mt-4 font-bold">
                                    ▼ブランチ名を変更
                                </p>
                                <SyntaxHighlighter
                                ...
                                「git checkout -b
                                ブランチ名」のように「-b」オプションを付けることで、ブランチの作成と切り替えを同時に行うことができます。
                                <p className="mt-4 font-bold">
                                ...
                                <a
                                    href="https://qiita.com/yuya_yuzen/items/274b8e9cde840492d7e8"
                                ...
                                上記コマンドの後ろに「-l
                                文字列」とオブションを追加することで、指定した文字列で始まるタグのみを表示することができます。
                                <p className="mt-4 font-bold">
                                    ▼タグの詳細を表示する
                                </p>
                                <SyntaxHighlighter
                                ...
                                dropの後に「stash@{"{"}スタッシュ番号{"}"}
                                」をつけると特定の退避作業を、「clear」をつけるとすべての退避中作業が削除されます。
                                <br />
                                <br />
                    ...
                    <section>
                        ...
                        <div className="mt-8 md:p-8">
                            ...
                            <ul className="list-inside list-decimal md:p-8">
                                <li className="my-4">
                                    「git
                                    status」コマンドでコンフリクトが起きているファイルを特定する。（「both
                                    modified」と表示されているファイルがコンフリクトが起きているファイル）
                                </li>
                                <li className="my-4">
