    ...
    return (
        <div className="container mx-auto px-5 xl:px-52">
            ...
            <section>
                ...
                <div className="mt-8">
                    ...
                    <div className="md:pl-8">
                        ...
                        <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">CSS(Tailwindcss)</h3>
                        <p className="pl-4">
                        ...
                        <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">JavaScript</h3>
                        <p className="pl-4">
                        ...
                        <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">React</h3>
                        <p className="pl-4">
                        ...
                        <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">Next.js</h3>
                        <p className="pl-4">
                        ...
                        <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">Vercel</h3>
                        <p className="pl-4">
            ...
            <section>
                ...
                <div className="md:pl-8">
                    <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">0～1ヶ月半程度 : HTML, CSSの勉強</h3>
                    <p className="pl-4">
                    ...
                    <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">1ヶ月半～2ヶ月 : JavaScriptの勉強</h3>
                    <p className="pl-4">
                    ...
                    <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">2ヶ月～2ヶ月半 : Reactの勉強</h3>
                    <p className="pl-4">
                    ...
                    <h3 className="my-2 font-bold underline decoration-dotted underline-offset-4">2ヶ月半～3ヶ月 : Next.jsの勉強とブログ制作</h3>
                    <p className="pl-4">
