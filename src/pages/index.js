                        ...
                        <div className="flex flex-wrap">
                                    ...
                                    <div className="overflow-hidden rounded-lg border-2 border-gray-200 border-opacity-60 duration-300 hover:scale-105">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex flex-wrap items-center">
                                                <p className="inline-flex items-center  border-l-neutral-700 md:mb-2 lg:mb-0">更新日 : 2023/8/28</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                                ...
                                <Link href="/posts/docker-memo">
                                    <div className="overflow-hidden rounded-lg border-2 border-gray-200 border-opacity-60 duration-300 hover:scale-105">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex flex-wrap items-center">
                                                <p className="inline-flex items-center  border-l-neutral-700 md:mb-2 lg:mb-0">更新日 : 2023/8/27</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
                            ...
                            <div className="w-full p-4 md:w-1/2">
                                <Link href="/posts/git-command">
                                    <div className="overflow-hidden rounded-lg border-2 border-gray-200 border-opacity-60 duration-300 hover:scale-105">
                                        <img className="w-full object-cover object-center md:h-36 lg:h-48" src="images/thumbnail/git_command_thumbnail.png" alt="blog" />
                                        <div className="p-6">
                                            <div className="overflow-hidden  md:h-16">
                                                <h1 className="title-font md:h-15 mb-3 border-l-neutral-700 text-lg font-medium line-clamp-2">
                                                Gitのコマンドをまとめてみた
                                ...
                                <Link href="/posts/made-blog-with-nextjs">
                                    <div className="overflow-hidden rounded-lg border-2 border-gray-200 border-opacity-60 duration-300 hover:scale-105">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex flex-wrap items-center">
                                                <p className="inline-flex items-center  border-l-neutral-700 md:mb-2 lg:mb-0">更新日 : 2023/5/13</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
